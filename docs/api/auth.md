...
Процес авторізації на тестовому стенді.

- Отримав список авторізаційних методів і отримання ідентифікатора процеса для типу авторізації authorization
- Отримання адреси авторізації для вибраного банку
- Підтверждення авторізаційного коду від банку
- Отримання токена авторізації Дія
...
Виклик створення тестового авторізаційного токена із невалідним РНОКПП (111)
```shell
...
Виклик створення тестового авторізаційного токена із технічно валідним РНОКПП (8111111111)
```shell
